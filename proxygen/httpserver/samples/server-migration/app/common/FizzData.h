...
// Certificates and keys copied from the "hq" example.
// What follows is used for test purposes only.
const std::string kDefaultCertificateData = R"(
-----BEGIN CERTIFICATE-----
...
const std::string kPrime256v1CertificateData = R"(
-----BEGIN CERTIFICATE-----
