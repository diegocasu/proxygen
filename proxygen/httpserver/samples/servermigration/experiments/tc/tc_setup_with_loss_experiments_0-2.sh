...
sudo tc class add dev enp4s0 parent 1: classid 1:1 htb rate 13mbit
...
sudo tc qdisc add dev enp4s0 parent 1:1 handle 10: netem delay 122ms loss 3%
...
sudo tc qdisc add dev enp4s0 parent 1:2 handle 20: netem delay 18ms loss 3%
